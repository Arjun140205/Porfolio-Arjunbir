...
export default function RadialOrbitalTimeline({
  ...
  const calculateNodePosition = (index, total, orbitRadius = 200) => {
    ...
    <div
      ...
      <div
        ...
        <div
          ...
          <div className="absolute w-[360px] h-[360px] rounded-full border border-white/20"></div>
          <div className="absolute w-[520px] h-[520px] rounded-full border border-white/20"></div>
          <div className="absolute w-[680px] h-[680px] rounded-full border border-white/20"></div>

          {timelineData.map((item, index) => {
            // Group items by orbit and calculate position within that orbit
            const itemsInSameOrbit = timelineData.filter(i => i.orbitRadius === item.orbitRadius);
            const indexInOrbit = itemsInSameOrbit.findIndex(i => i.id === item.id);
            const position = calculateNodePosition(indexInOrbit, itemsInSameOrbit.length, item.orbitRadius || 200);
